...
admin=["u21a6c9ed9087408cabab8c0bfbb28702","u888ed4a484121b2b9860b1b391e80530"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        if wait["lang"] == "JP":
                            ...
                            cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gy1 curl","Gy1 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
            ...
            elif msg.text in ["Gy2 curl","Gy2 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = kk.getGroup(msg.to)
                        X.preventJoinByTicket = True
                        ...
                        if wait["lang"] == "JP":
                            ...
                            kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gy3 curl","Gy3 link off"]:
                if msg.from_ in admin:
                    if msg.toType == 2:
                        X = kc.getGroup(msg.to)
                        X.preventJoinByTicket = True
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                if msg.from_ in admin:
                        cl.sendText(msg.to, "Sider Awas Tercyduck")
                        try:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        ki.sendText(msg.to,"Siap laksanakan")
                        kk.sendText(msg.to,"Grup akan di basmi")
...
#-----------------------------------------------Spam
        ...
        #----------------Fungsi Kick User Target Start----------------------#
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"Woy")
                       kk.sendText(g.mid,"Woy")
                       ki.sendText(g.mid,"Woy")
                       kc.sendText(g.mid,"Coeg")
                       ks.sendText(g.mid,"Coeg")
                       ka.sendText(g.mid,"Coeg")
                       kb.sendText(g.mid,"Coeg")
                       cl.sendText(msg.to, "Coeg")
                       print " Spammed !"
#-----------------------------------------------
...
#-------itucopyajajangandiedit------
                ...
                if msg.toType == 2:
                      ...
                      try:
                        ...
                        Creatorbot = "Error"
                      cl.sendText(msg.to, "My Creator : Dhani Yanuar")
                      cl.sendMessage(msg)
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ki.sendText(msg.to,"Iya hadirrrr..")
#-----------------------------------------------
            elif "Bc " in msg.text:
                if msg.from_ in admin:
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    ...
                    kk.sendText(msg.to,".........")
                    kc.sendText(msg.to,"............")
                    cl.sendText(msg.to,"Complete 100%")
#-----------------------------------------------
